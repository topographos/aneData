...
* [Submit a post for your issue](https://github.com/topographos/aneData/issues/), assuming one does not already exist.
...
* [Fork](https://github.com/topographos/aneData/#fork-destination-box) the repository on GitHub to make a copy of the repository on your account. Or use this line in your shell terminal:

    `git clone git@github.com:your-username/aneData.git`
...
* If you need help or unsure about anything, post an update to [your issue](https://github.com/topographos/aneData/issues/).

## Submitting your changes

Push to your fork and [submit a pull request](https://github.com/topographos/aneData/compare/).
...
* Engage in discussion on [your issue](https://github.com/topographos/aneData/issues/).
